...
const Movies = () =>{
    const [mediaType, setMediaType] = useState("mov")
    ...
    const handleMediaType =(e)=>{
        if((mediaType && e.target.textContent === "Movies") || (!mediaType && e.target.textContent === "TV")){
           return 
        }
    ...
    return ( 
        <div>
            <div className={css.moviesHeader}>
                ...
                <button onClick={(e)=>handleMediaType(e)} className={`${css.mediaButton} ${mediaType && css.mediaButtonActive}`}>Movies</button>
                <button onClick={(e)=>handleMediaType(e)} className={`${css.mediaButton} ${!mediaType && css.mediaButtonActive}`}>TV</button>
